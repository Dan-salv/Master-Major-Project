...
def print_scores(scores):
    ...
    with open("data/training_data/scores/training_scores_pep_flip.json", "w") as outfile:
...
def run_script():
    ...
    model3 = Pipeline(steps= [("preprocess", data_transform), ('kbest', kbest) ,('svm', SVM)] )
